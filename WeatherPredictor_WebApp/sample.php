...
function validateform() {
 ...
 if(street == null || (!street.match(/\S/))) {
   alert ("Please enter the street address");
   return false;     
 }
    
 if(city == null || (!city.match(/\S/)) ) {
...
function resetform() {
    ...
    formdetails[0]["degree"].value="Fahrenheit";
    formdetails[0]["degree"].checked="true";
...
<form onsubmit="return validateform()" method="post" action="forecast.php">
...
<br/><br/>     
Degree:*  <input type="radio" id="degree" name="degree" value="Fahrenheit" checked="checked" <?php if (isset($_POST[ 'degree']) && $_POST[ 'degree']=='Fahrenheit' ){echo "checked='checked'";}?>/>Fahrenheit
                <input type="radio" id="degree" name="degree" value="Celsius" <?php if (isset($_POST['degree']) && $_POST[ 'degree']=='Celsius' ){echo "checked='checked'";}?>/>Celsius</br> 
